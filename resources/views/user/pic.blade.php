  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="editPicModalLabel"> Profiilikuvan muokkaus</h4>
      </div>

      {!! Form::open(array('action'=>array('UserController@addPic', $user->id), 'method'=>'post', 'files' => true)) !!}
...
<div class="modal fade" id="delPicModal" tabindex="-1" role="dialog" aria-labelledby="delPicModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        {{Form::open(array('action'=>array('UserController@delPic', $user->id), 'method'=>'post'))}}
        <button type="button" class="btn btn-default" data-dismiss="modal">Peruuta</button>
